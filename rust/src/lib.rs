//! Windissect-generated Rust FFI bindings for coml2.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "1723CD23737D8335C38BBD3710F9EEB7";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 2188252060;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 10] = [99, 111, 109, 108, 50, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 2188252060 { return 0; }
